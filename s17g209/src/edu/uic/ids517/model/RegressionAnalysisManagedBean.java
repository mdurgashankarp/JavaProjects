...
public class RegressionAnalysisManagedBean {
	...
	private double totalMeanSquares;
	...
	public RegressionAnalysisManagedBean() {
	}

	public boolean setRegressionAnalysisVariables(String regressionEquation, double intercept,
			double interceptStandardError, double tStatistic, double interceptPValue, double slope,
			double slopeStandardError, double tStatisticPredictor, double pValuePredictor, double standardErrorModel,
			double rSquare, double rSquareAdjusted, double predictorDF, double residualErrorDF, double totalDF,
			double regressionSumSquares, double sumSquaredErrors, double totalSumSquares,double totalMeanSquares, double meanSquare,
			double meanSquareError, double fValue, double pValue) {
		try {
			...
			this.totalMeanSquares = totalMeanSquares;
	...
	public double getTotalMeanSquares() {
		return totalMeanSquares;
	}

	public void setTotalMeanSquares(double totalMeanSquares) {
		this.totalMeanSquares = totalMeanSquares;
	}
