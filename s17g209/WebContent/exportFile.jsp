	...
	<f:view>
		...
		<div align="center">
			<h:form>
				...
				<h:outputText value="#{messagesBean.successMessage}"
					style="color:green" rendered="#{messagesBean.renderSuccessMessage}" />
				<h:panelGrid columns="8">
					<h:commandButton type="submit" value="Export CSV"
						action="#{dbAccessActionBean.exportCSV}" />
					<h:commandButton type="submit" value="Export XML"
						action="#{dbAccessActionBean.exportXML}" />
